...
# This service shares the database with other services, so it keeps its
# own version tracking table to avoid clashing with their chains.
VERSION_TABLE = "market_alembic_version"
